...
def copyWifiFirmware(){
    ...
    // Copy over
    sh """
        cp gsdk/extension/wifi_sdk/connectivity_firmware/SiWG917-B.*.rps ${savedDirectory}/out/WiFi-Firmware/BRD4338A/
        cp gsdk/extension/wifi_sdk/connectivity_firmware/SiWG917-B.*.rps ${savedDirectory}/out/WiFi-Firmware/917-ncp/
